        ...
        <div class="navbar-custom-menu">
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <img src="{{ asset('admin-template/dist/img/user2-160x160.jpg')}}" class="user-image" alt="User Image">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active">
          <a href="{{url('dashboard')}}"><i class="fa fa-link"></i> <span>Dashboard</span></a>
        </li>
        <li class="">
          <a href="{{url('dashboard/product')}}"><i class="fa fa-link"></i> <span>Product List</span></a>
        </li>
        <li class="">
          <a href="{{url('dashboard/category')}}"><i class="fa fa-link"></i> <span>Category List</span></a>
        </li> 
